...
//            $where1['username'] = ['like', '%' . $data['username'] . '%'] ;
////            $where2=[];
////            $where2['username'] = ['like', '%' . $data['username'] . '%'];
//        }else if(isset($data['phone']) && !empty($data['phone'])){
////            $where1=[];
//            $where1['phone'] = ['phone', '%' . $data['phone'] . '%'] ;
////            $where2['phone'] = ['phone', '%' . $data['phone'] . '%'];
//        }else{
//            $where1=[];
////            $where2=[];
//        };
       $ids= $this::where($where1)->where($where2)->column('uid');
//        (isset($data['phone']) && !empty($data['phone'])) ? $where2['phone'] = ['like', '%' . $data['phone'] . '%']:$where2=[];
...
//        }
        if($data['mg_name']=='admin' && $data['manager']===''){
            ...
            if(is_array($data['manager'])){
                $data['manager']=implode(',',$data['manager']);
                $whererent1['mg_id']=['in',$data['manager']];
                $whererent2['mg_id']=['in',$data['manager']];
            }else{
                $whererent1['mg_id']=['eq',$data['manager']];
                $whererent2['mg_id']=['eq',$data['manager']];
            }
        }else if($data['mg_name']!='admin'){
            $whererent1['mg_id']=['eq',$data['mg_id']];
            $whererent2['mg_id']=['eq',$data['mg_id']];
        }
