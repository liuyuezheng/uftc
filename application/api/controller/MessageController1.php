        ...
        foreach ($res as $key){
            ...
            if(!empty($con)){
                     ...
                     if($list['status']==2){
                         ...
                         $aa['endtime']=date('Y-m-d H:i',$list['endtime']);
                         if(empty($con1) && empty($con2) && empty($con3) && empty($con5)){
                         ...
                         }else if(empty($con2) && empty($con3) && empty($con5)){
                           ...
                           if($time<$week){
                               ...
                               if(empty($con2) && empty($con3) && empty($con5)){
                                   $up3=array(
                                       'uid'=>$uid,
                                       'mg_id'=>$list['mg_id'],
                                       'p_number'=>$list['p_number'],
                               ...
                               if(empty($con2) && empty($con3) && empty($con5)){
                                   ...
                                   Db::table('pk_message')->insert($up5);
                                   Db::table('pk_message')->insert($up3);
                                   Db::table('pk_message')->insert($up4);
                               }

                           }
                         }else if(empty($con3) && empty($con5)){
                             ...
                             if($time>$list['endtime']){
                                 if(empty($con3) && empty($con5)){
                                     $up4=array(
                                         'uid'=>$uid,
                                         'mg_id'=>$list['mg_id'],
                                         'p_number'=>$list['p_number'],
                             ...
                             if($time >$list['endtime'] && empty($con5) ){
                                 $up5=array(
                                     'uid'=>$uid,
                                     'mg_id'=>$list['mg_id'],
                                     'p_number'=>$list['p_number'],
                         ...
                         }else if($time >$list['endtime'] && empty($con5) ){
                             $up5=array(
                                 'uid'=>$uid,
                                 'mg_id'=>$list['mg_id'],
                                 'p_number'=>$list['p_number'],
...
//                         $con5=Db::table('pk_message')->where($list)->order('createtime asc')->select();//查询用户是否已接收过消息
                         if(empty($con4) && empty($con5)){
                             ...
                             if ($time>$list['endtime']){
                                 if(empty($con4) && empty($con5)){
                                     ...
                                     Db::table('pk_message')->insert($adms1);
                                 }
                         ...
                         if(empty($con5)){
                             ...
                             if($time>$list['endtime']){
                                 ...
                                 $maves1=Db::table('pk_message')->insert($adms3);
                             }
                         }
                     }
