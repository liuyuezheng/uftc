<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"D:\park\public/../application/admin\view\carcharge\index.html";i:1543287865;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
	<form name="form" method='post' action="<?php echo url('admin/carcharge/index'); ?>">
		<div style="margin-left:30px;margin-bottom:18px;">
			<div data-toggle="distpicker">
				<div data-toggle="distpicker">
				  ...
				  <div class="form-group">
			车牌号: <input type="text" class="input-text" style="width:150px;" placeholder="请输入内容" value="<?php echo $shuju['data']['plate']; ?>" name="plate" >
			停车类型: <select name='reason' style='width:150px;margin-right:10px;' class="input-text">
					<option value='0'>--请选择--</option>
					<option value='1' <?php if($shuju['data']['reason'] == '1'): ?>selected<?php endif; ?>>租用</option>
					<option value='2' <?php if($shuju['data']['reason'] == '2'): ?>selected<?php endif; ?>>共享</option>
					<option value='3' <?php if($shuju['data']['reason'] == '3'): ?>selected<?php endif; ?>>临时</option>
				 </select>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<thead>
			<tr class="text-c">
				<th width="100">车牌号</th>
				<!--<th width="100">停靠时长</th>-->
				<th width="100">停车类型</th>
		...
		<tbody>
			...
			<?php else: if(is_array($shuju['page']) || $shuju['page'] instanceof \think\Collection || $shuju['page'] instanceof \think\Paginator): $i = 0; $__LIST__ = $shuju['page'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
				...
				<!--<td><?php echo $val['timelong']; ?></td>-->
				<td>
					<?php if($val['reason'] == '1'): ?>租用<?php endif; if($val['reason'] == '2'): ?>共享<?php endif; if($val['reason'] == '3'): ?>临时<?php endif; ?>
				</td>
