<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:57:"D:\park\public/../application/admin\view\index\index.html";i:1535618689;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl">
			<span class="logo navbar-slogan f-l mr-10 hidden-xs"><img src="/uploads/defaultimg.jpg" style="height:25px;margin-right:8px;">优服停车后台</span> 
			...
			<ul class="cl">
				...
				<li class="dropDown dropDown_hover">
					...
					<ul class="dropDown-menu menu radius box-shadow">
						<li><a href="<?php echo url('admin/manager/logout'); ?>">退出</a></li>
				</ul>
			</li>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-article">
			<dt><i class="Hui-iconfont">&#xe616;</i> <?php echo $v['ps_name']; ?><i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					...
					<li><a data-href="/admin/<?php echo $vv['ps_c']; ?>/<?php echo $vv['ps_a']; ?>" data-title="<?php echo $vv['ps_name']; ?>" href="javascript:void(0)"><?php echo $vv['ps_name']; ?></a>
					</li>
