<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"D:\park\public/../application/admin\view\alluser\index.html";i:1545709839;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
	<form name="form" method='post' action="<?php echo url('admin/alluser/index'); ?>">
...
height="40"></a></div></td>
				<!--<td class="td-manage">-->
					<!--<a title="编辑" href="javascript:;" onclick="member_edit('编辑','<?php echo url('admin/user/personedit',['uid'=>$val['uid']]); ?>','4','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>-->
				<!--</td>-->
			</tr>
