<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"D:\park\public/../application/admin\view\user\rentindex.html";i:1543559913;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
	<form name="form" method='post' action="<?php echo url('admin/user/rentindex'); ?>">
		...
		<?php else: ?>
		<div class="text-c" style="float:left;margin-left:30px;margin-bottom:18px;">
			用户名称: <input type="text" class="input-text" style="width:150px;" placeholder="请输入内容" value="<?php echo $shuju['data']['username']; ?>" name="username" >
			联系方式: <input type="text" class="input-text" style="width:150px;" placeholder="请输入内容" value="<?php echo $shuju['data']['phone']; ?>" name="phone" >
			<input type="submit" class="btn btn-success radius" value="搜索">
		</div>
	...
	<!--  <span class="l" style="margin-left:10px;"> <a href="javascript:;" onclick="member_add('添加租赁用户','<?php echo url('admin/user/rentadd'); ?>','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加租赁用户</a></span> -->
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			...
			<?php else: if(is_array($shuju['pages']) || $shuju['pages'] instanceof \think\Collection || $shuju['pages'] instanceof \think\Paginator): $i = 0; $__LIST__ = $shuju['pages'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
				<tr class="text-c">
				...
				<!--<td class="td-manage">-->
					<!--<a title="编辑" href="javascript:;" onclick="member_edit('编辑','<?php echo url('admin/user/rentedit',['uid'=>$val['uid']]); ?>','4','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>-->
				<!--</td>-->
			</tr>
