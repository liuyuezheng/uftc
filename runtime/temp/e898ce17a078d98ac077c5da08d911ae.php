<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"D:\park\public/../application/admin\view\manager\login.html";i:1545202661;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="header" style="color: #aee1fb;"><h1 style="padding-top: 8px;padding-left: 36px;">优服停车</h1></div>
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <div align="center"><?php echo (isset($errorinfo) && ($errorinfo !== '')?$errorinfo:''); ?></div>
    <form class="form form-horizontal" action="<?php echo \think\Request::instance()->url(); ?>" method="post">
      <div class="row cl">
        <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60d;</i></label>
        <div class="formControls col-xs-8">
          <input id="mg_name" name="mg_name" type="text" placeholder="账户" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
        <div class="formControls col-xs-8">
          <input id="mg_pwd" name="password" type="password" placeholder="密码" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <input class="input-text size-L" name="verify_code" type="text" placeholder="验证码" onblur="if(this.value==''){this.value='验证码:'}" onclick="if(this.value=='验证码:'){this.value='';}" value="验证码:" style="width:150px;">

           <img src="<?php echo captcha_src(); ?>" alt="验证码" width="145" height="40"
            onclick="this.src=this.src+'?'+Math.random()" style="margin-left: 50px;"
          /> 
        </div>
      </div>
      <div class="row cl">
...
<div class="footer">Copyright 优服停车</div>
