<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"D:\park\public/../application/admin\view\stopcar\index.html";i:1543457703;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
	<meta charset="utf-8">
...
<div class="page-container">
	<form name="form" method='post' action="<?php echo url('admin/stopcar/index'); ?>">
	...
	<div class="mt-20" style="margin-top:20px;">
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<tr class="text-c">
				...
				<?php endif; ?>
				<!--<?php if($shuju['data']['mg_name'] == 'admin'): ?>-->
				<!--&lt;!&ndash;<th width="100">停车场</th>&ndash;&gt;-->
				<!--<td><?php echo $val['name']; ?></td>-->
				<!--<?php endif; ?>-->
				<!--<th width="100">车位号</th>-->
