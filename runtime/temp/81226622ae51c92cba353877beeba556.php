<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"D:\park\public/../application/admin\view\carposs\hisindex.html";i:1542941171;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
	<form name="form" method='post' action="<?php echo url('admin/carposs/hisindex'); ?>">
		...
		<div class="form-group" >
			...
			车位类型：<select name='types' style='width:150px;margin-right:10px;' class="input-text">
					...
					<option value='2' <?php if($shuju['data']['types'] == '2'): ?>selected<?php endif; ?>>专属</option>
		...
		<div class="form-group" style="margin-left:20px;">
			...
			车位类型：<select name='types' style='width:150px;margin-right:10px;' class="input-text">
					...
					<option value='2' <?php if($shuju['data']['types'] == '2'): ?>selected<?php endif; ?>>专属</option>
					<option value='3' <?php if($shuju['data']['types'] == '3'): ?>selected<?php endif; ?>>共享</option>
			        <option value='3' <?php if($shuju['data']['types'] == '4'): ?>selected<?php endif; ?>>临时</option>
				 </select>
			<input type="submit" class="btn btn-success radius" value="搜索">
		</div>
		<?php endif; ?>
...
height="40"></a></div></td>
				<td>
					...
					<!--<?php else: ?>-->
						<!--<?php echo $val['charge']; ?>-->
					<!--<?php endif; ?>-->
					<?php echo $val['price']; if($val['types'] == '2'): ?>/月<?php endif; if($val['types'] == '3'): ?>/小时<?php endif; if($val['types'] == '4'): ?>/小时<?php endif; ?>
				</td>
				...
				<td><?php if(!(empty($val['rentname']) || (($val['rentname'] instanceof \think\Collection || $val['rentname'] instanceof \think\Paginator ) && $val['rentname']->isEmpty()))): ?>
						<?php echo $val['rentname']; endif; ?></td>
				<!--<td>-->
